...
const JSON_FILENAME_WRITER = path.join(__dirname, 'logs', 'pipe-details.json');
const READ_LENGTH = 4;
...
writer.on('pipe', data => {
  console.log('writer pipe', { from: data.path, to: data._readableState.pipes.path });
});
...
//   // }
//   console.log('reader readable', { data });
// });
